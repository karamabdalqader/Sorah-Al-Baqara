...
{CONTENT}
    ...
    <div class="mt-24 mb-32 flex flex-col items-center opacity-60 dark:opacity-60 select-none transition-colors">
        <span class="font-arabic text-4xl sm:text-[42px] text-accent font-bold">صَدَقَ اللَّهُ الْعَظِيمُ</span>
    </div>
</main>
